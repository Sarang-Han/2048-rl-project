  ...
  return (
    <div className={`${className}`}>
      ...
      <div className="flex gap-3 justify-center flex-wrap">
        {/* SCORE */}
        <div 
          className="px-6 py-3 rounded-2xl text-center min-w-[100px] backdrop-blur-sm"
          style={{ 
        ...
        >
          ...
          <div className="text-2xl font-black mt-1" style={{ color: '#ffffff', textShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>
        ...
        >
          ...
          <div className="text-2xl font-black mt-1" style={{ color: '#6d5d4a', textShadow: '0 1px 1px rgba(255,255,255,0.3)' }}>
      ...
      {errorCount > 0 && (
        <div 
          className="text-center p-3 rounded-2xl backdrop-blur-sm mt-3"
          style={{ 
