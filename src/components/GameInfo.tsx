      ...
      <div className="flex gap-2 justify-center">
        ...
        <div 
          ...
          style={{ 
            ...
            boxShadow: '0 3px 12px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.2)'
          }}
        >
        ...
        <div 
          ...
          style={{ 
            ...
            boxShadow: '0 3px 10px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.3)'
          }}
        >
      ...
      {errorCount > 0 && (
        <div 
          ...
          style={{ 
            ...
            boxShadow: '0 4px 16px rgba(246,94,59,0.25)'
          }}
        >
